...
public class Panel 
{
	...
	public void Draw(DoraemonWorld mv, Canvas canvas,Paint paint)
	{
		...
		if(mv.getNowLevel().getTime() <= 100 && mv.getGameState() == DoraemonWorld.GAME_ING) paint.setColor(Color.RED);
