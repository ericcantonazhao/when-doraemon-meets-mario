...
public class DoraemonWorld extends GameView implements Runnable
{
	...
	public DoraemonWorld(Context context,int gamelevel)
	{
		super(context);
		...
		mario = new Mario(80,0,LoadResourceOfDore.mario.get(0),context);
		
		this.panel = new Panel();
		
		this.B = new GameButton(0,  LoadActivity.ScreenHeight - LoadResourceOfDore.button.get(4).getHeight(), LoadResourceOfDore.button.get(4));
	...
	public void Logic()
	{
		...
		{
			Enemy e = this.nowLevel.getEnemy().get(i);
			if(e.name.equals("tortoise") && e.state.equals("torshell") && e.xSpeed >0)
			{
